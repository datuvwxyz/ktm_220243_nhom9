<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <h6 class="collapse-header">Tùy chọn biểu ngữ:</h6>
        <a class="collapse-item" href="{{route('banner.index')}}">Danh sách biểu ngữ</a>
        <a class="collapse-item" href="{{route('banner.create')}}">Thêm biểu ngữ</a>
      </div>
    </div>
  </li>
  <!-- Divider -->
  ...
  <li class="nav-item">
    ...
    <div id="shippingCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <h6 class="collapse-header">Tùy chọn giao hàng:</h6>
        <a class="collapse-item" href="{{route('shipping.index')}}">Danh sách giao hàng</a>
        <a class="collapse-item" href="{{route('shipping.create')}}">Thêm giao hàng</a>
      </div>
    </div>
  </li>
  ...
  <li class="nav-item">
    ...
    <div id="postCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="{{route('post.index')}}">Danh sách bài đăng</a>
