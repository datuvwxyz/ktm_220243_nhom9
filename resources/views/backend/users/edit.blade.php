...
<div class="card">
    <h5 class="card-header">Chỉnh sửa khách hàng</h5>
    <div class="card-body">
      <form method="post" action="{{route('users.update',$user->id)}}">
        ...
        <input id="inputTitle" type="text" name="name" placeholder="Nhập tên khách hàng"  value="{{$user->name}}" class="form-control">
        @error('name')
