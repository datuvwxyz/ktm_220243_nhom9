                ...
                <div class="col-lg-8 col-12">
                    <div class="checkout-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    <label>Thành phố, quận, huyện<span>*</span></label>
                ...
                <div class="col-lg-4 col-12">
                    <div class="order-details">
                        ...
                        <div class="single-widget">
                            ...
                            <div class="content">
                                <ul>
                                    <li class="order_subtotal" data-price="{{Helper::totalCartPrice()}}">Tổng<span>${{number_format(Helper::totalCartPrice(),2)}}</span></li>
                                    <li class="shipping">
                                        Chi phí vận chuyển
                                    ...
                                    @if(session('coupon'))
                                    <li class="coupon_price" data-price="{{session('coupon')['value']}}">Giảm giá<span>${{number_format(session('coupon')['value'],2)}}</span></li>
                                    @endif
                                    @php
                        ...
                        <div class="single-widget">
                            ...
                            <div class="content">
                                <div class="checkbox">
                                    ...
                                    <form-group>
                                        <input name="payment_method" type="radio" value="cod"> <label> Thanh toán bằng tiền mặt</label><br>
                                        <input name="payment_method" type="radio" value="paypal"> <label> Ngân hàng</label>
                                    </form-group>
