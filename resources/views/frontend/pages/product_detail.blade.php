...
@endsection
@section('title','SneakerApp || Chi tiết sản phẩm')
								...
								<div class="row">
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<!-- Color -->
											{{-- <div class="color">
												<h4>Tùy chọn <span>màu sắc</span></h4>
												<ul>
											...
											<div class="product-buy">
												...
												@endif
												<p class="availability">Còn sẵn : @if($product_detail->stock>0)<span class="badge badge-success">{{$product_detail->stock}}</span>@else <span class="badge badge-danger">{{$product_detail->stock}}</span>  @endif</p>
											</div>
											<!--/ End Product Buy -->
										</div>
									</div>
